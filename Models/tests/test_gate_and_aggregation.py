...
def test_prediction_pipeline_normalizes_raw_vectors_with_bounds():
    ...
    pipeline.feature_bounds = {name: {"min": 0.0, "max": 1.0} for name in FEATURE_NAMES_29}
    pipeline.feature_bounds["wmc"] = {"min": 10.0, "max": 30.0}
    pipeline.feature_bounds["cbo"] = {"min": 0.0, "max": 10.0}

    vector = [20.0, 20.0, -1.0, *([0.5] * (len(FEATURE_NAMES_29) - 3))]
