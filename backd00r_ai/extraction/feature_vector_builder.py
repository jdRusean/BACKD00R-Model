"""Build the canonical BACKD00R 23-feature vector."""
...
class FeatureVectorBuilder:
    def build(
        ...
        merged: dict[str, Any] = {
            **{name: 0.0 for name in FEATURE_NAMES_23},
            **reconstructed,
            **historical,
            **expert_derived,
        }
        vector = [float(merged[name]) for name in FEATURE_NAMES_23]
